      ...
      <div class="container">
        ...
        <div class="grid_3 grid_4 wow fadeInLeft animated" data-wow-delay=".5s">
          ...
          <div class="bs-example">
            <div class="mb-60">
              <h1>Heading H1</h1>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Expedita saepe veniam quo
                consequuntur ad totam rem aliquid voluptates hic eos ullam, sequi nihil necessitatibus
                beatae perspiciatis perferendis, eveniet at esse vero molestiae debitis distinctio sunt
                modi. Repellat, eligendi, eius! Veritatis in veniam, tempora tempore ratione provident. Sunt
                nulla similique voluptates magni labore maxime tempore error sed necessitatibus ab.
                Quisquam, nisi.
              </p>
              <h2>Heading H2</h2>
              <p>
        ...
        <div class="col-sm-6 col-md-6 col-lg-6 mb-60">
          ...
          <div class="horizontal-tab">
            <ul class="nav nav-tabs">
              <li class>
                <a href="#tab1" data-toggle="tab" aria-expanded="false">Tab1</a>
              </li>
              <li class>
                <a href="#tab2" data-toggle="tab" aria-expanded="false">Tab2</a>
              </li>
              <li class>
                <a href="#tab3" data-toggle="tab" aria-expanded="false">Tab3</a>
              </li>
              <li class="active">
                <a href="#tab4" data-toggle="tab" aria-expanded="true">Tab4</a>
              </li>
            </ul>
            <div class="tab-content">
              <div class="tab-pane fade" id="tab1">
                <div class="row">
                  <div class="col-md-12">
                    <p>
                      Tab 1 : Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestias atque
                      autem fuga similique, mollitia impedit maxime sapiente omnis blanditiis qui iste
                      aliquam, quisquam eos, earum.
                    </p>
                    <p>
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quaerat ex hic, maiores
                      excepturi, doloribus modi.
                    </p>
                  </div>
                </div>
              </div>
              <div class="tab-pane" id="tab2">
                <div class="row">
                  <div class="col-md-12">
                    <p>
                      Tab 2 : Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestias atque
                      autem fuga similique, mollitia impedit maxime sapiente omnis blanditiis qui iste
                      aliquam, quisquam eos, earum.
                    </p>
                    <p>
              ...
              <div class="tab-pane" id="tab3">
                <div class="row">
                  <div class="col-md-12">
                    <p>
                      Tab 3 : Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestias atque
                      autem fuga similique, mollitia impedit maxime sapiente omnis blanditiis qui iste
                      aliquam, quisquam eos, earum.
                    </p>
                    <p>
              ...
              <div class="tab-pane active in" id="tab4">
                <div class="row">
                  <div class="col-md-12">
                    <p>
                      Tab 4 : Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestias atque
                      autem fuga similique, mollitia impedit maxime sapiente omnis blanditiis qui iste
                      aliquam, quisquam eos, earum.
                    </p>
                    <p>
        ...
        <div class="grid_3 grid_5 wow fadeInLeft animated" data-wow-delay=".5s">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="domprogress">
              ...
              <p>
                Info with
                <code>progress-bar-info</code> class.
              </p>
              <div class="progress">
              ...
              <p>
                Success with
                <code>progress-bar-success</code> class.
              </p>
              <div class="progress">
              ...
              <p>
                Warning with
                <code>progress-bar-warning</code> class.
              </p>
              <div class="progress">
              ...
              <p>
                Danger with
                <code>progress-bar-danger</code> class.
              </p>
              <div class="progress">
              ...
              <p>
                Inverse with
                <code>progress-bar-inverse</code> class.
              </p>
              <div class="progress">
            ...
            <div id="myTabContent" class="tab-content">
              ...
              >
                <p>
                  ...
                  beer marfa ethical. Wolf salvia freegan, sartorial keffiyeh echo park vegan.
                </p>
              </div>
            </div>
          </div>
        ...
        <section id="tables">
          ...
          <p>
            ...
            <code>.table</code> base class.
          </p>
          <p>
            Adds zebra-striping to any table row within the
            <code>&lt;tbody&gt;</code> via the
            <code>:nth-child</code> CSS selector (not available in IE7-8).
          </p>
          <div class="bs-docs-example">
