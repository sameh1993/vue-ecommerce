...
function saveUpdatedPro() {
  Router.push("/store/details");
  store.commit("store/saveUpdatedPro");
  notify({
    text: "تم تعديل الصنف",
  });
}
  ...
  <div class="add-product position-relative">
    <div class="body">
      <div class="content bg-white">
        ...
        <!-- [ batcode -  ] -->
        <form @submit.prevent="saveUpdatedPro" class="form">
          ...
          <div class="form-floating mb-3">
            <input
              v-model="editingProduct.boxPrice"
              type="text"
              class="form-control"
              id="boxPrice"
            />
          ...
          <div class="form-floating mb-3">
            <input
              v-model="editingProduct.boxUnitCount"
              type="text"
              class="form-control"
              id="boxUnitCount"
            />
          ...
          <div class="form-floating mb-3">
            <input
              v-model="editingProduct.balance"
              type="text"
              class="form-control"
              id="balance"
            />
